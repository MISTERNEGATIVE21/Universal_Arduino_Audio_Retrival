...
#define SAMPLE_RATE 40000  // Increased sample rate in Hz (adjust as needed)
#define BUFFER_SIZE 512   // Increased buffer size for storing samples
...
void setup() {
  ...
  // Configure ADC (10-bit resolution)
